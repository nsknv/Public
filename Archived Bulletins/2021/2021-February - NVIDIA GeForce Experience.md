# NVIDIA GeForce Experience (Bulletin ID: 5155)



 NVIDIA GeForce Experience - February 2021
============================================================
...
| --- | --- | --- | --- |
| CVE‑2021‑1072 | NVIDIA GeForce Experience software contains a vulnerability in GameStream (`rxdiag.dll`) where an arbitrary file deletion due to improper handling of log files may lead to denial of service. | 6.0 | [AV:L/AC:H/PR:L/UI:R/S:U/C:N/I:H/A:H](https://nvd.nist.gov/vuln-metrics/cvss/v3-calculator?vector=AV:L/AC:H/PR:L/UI:R/S:U/C:N/I:H/A:H) |
...
| --- | --- | --- |
| 1.0 | February 4, 2021 | Initial release |
